...
//    }
    ...
    public static void drawRect(float x1, float y1, float x2, float y2, int color) {
        Gui.drawRect(x1, y1, x1 + x2, y1 + y2, color);
    }
    public static void drawRectBetter(float x1, float y1, float x2, float y2, int color) {
...
//    }
    ...
    public static Color rainbow(long time, float count, float fade) {
        float hue = (System.currentTimeMillis() + (1.0F + count) * 2.0E8F) / 1.0E10F % 1.0F;
...
//        OpenGlHelper.glBlendFunc(770, 771, 1, 0);
    ...
    public static void drawRounded(float x, float y, float width, float height, int round, Color color) {
    ...
    public static void drawRoundedRectSkid(double x, double y, double x1, double y1, double radius, int color) {
        GL11.glPushAttrib(0);
    ...
    public static void drawRoundedRectSkid2(double x, double y, double x1, double y1, double radius, int color) {
        GL11.glPushAttrib(0);
        GL11.glEnable(3042);
        GL11.glDisable(3553);
        setColor(color);
        ...
        for (i = 0; i <= 90; i += 3)
            GL11.glVertex2d(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y + radius + Math.cos(i * Math.PI / 180.0D) * radius * -1.0D);
        for (i = 90; i <= 180; i += 3)
            GL11.glVertex2d(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y+y1 - radius + Math.cos(i * Math.PI / 180.0D) * radius * -1.0D);
        for (i = 0; i <= 90; i += 3)
            GL11.glVertex2d(x1+x - radius + Math.sin(i * Math.PI / 180.0D) * radius, y+y1 - radius + Math.cos(i * Math.PI / 180.0D) * radius);
        for (i = 90; i <= 180; i += 3)
            GL11.glVertex2d(x1+x - radius + Math.sin(i * Math.PI / 180.0D) * radius, y + radius + Math.cos(i * Math.PI / 180.0D) * radius);
        GL11.glEnd();
        GL11.glDisable(GL11.GL_BLEND);
        GL11.glDisable(3042);
        GL11.glDisable(2848);
    ...
    public static void drawRoundedRectSkid3(double x, double y, double x1, double y1, double radius, int color) {
        GL11.glPushAttrib(0);
        GL11.glEnable(3042);
        GL11.glDisable(3553);
        setColor(color);
        ...
        for (i = 0; i <= 90; i += 3)
            GL11.glVertex2d(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y + radius + Math.cos(i * Math.PI / 180.0D) * radius * -1.0D);
        for (i = 90; i <= 180; i += 3)
            GL11.glVertex2d(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y1);
        for (i = 0; i <= 90; i += 3)
            GL11.glVertex2d(x1 - radius + Math.sin(i * Math.PI / 180.0D) * radius, y1);
        for (i = 90; i <= 180; i += 3)
            GL11.glVertex2d(x1 - radius + Math.sin(i * Math.PI / 180.0D) * radius, y + radius + Math.cos(i * Math.PI / 180.0D) * radius);
        GL11.glEnd();
        GL11.glDisable(GL11.GL_BLEND);
    ...
    public static void drawRoundedRectSkid4(double x, double y, double x1, double y1, double radius, int color) {
        GL11.glPushAttrib(0);
        GL11.glEnable(3042);
        GL11.glDisable(3553);
        setColor(color);
