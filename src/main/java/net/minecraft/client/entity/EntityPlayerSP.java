...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        EventMotion e = new EventMotion(this.rotationYaw, this.rotationPitch, this.posX, this.posY, this.posZ, this.onGround);
        Manager.onEvent(e);
    ...
    public void sendChatMessage(String message)
    {
        ...
        this.sendQueue.addToSendQueue(new C01PacketChatMessage(e.getMessage()));
    }
