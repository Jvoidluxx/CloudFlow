...
public class GuiTextField extends Gui
{
     ...
     * Draws the textbox
     */
    public void drawCustomTextBox(cloud.main.utils.fontutils.FontRenderer fr)
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                RenderUtil.drawRoundedRectSkid(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, 5, -6250336);
                RenderUtil.drawRoundedRectSkid(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 5, -16777216);
            }
            ...
            if (!s.isEmpty())
            {
                ...
                j1 = (int) fr.drawStringWithShadow(s1, (float)l, (float)i1, i);
            }
            ...
            if (flag1)
            {
                if (flag2)
                {
                    RenderUtil.drawRoundedRectSkid(k1, i1 - 1, k1 + 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, 5, -3092272);
                }
                else
                {
                    fr.drawStringWithShadow("_", (float)k1, (float)i1, i);
                }
            }
